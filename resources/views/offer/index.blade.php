...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb calendar">
                    <li class="active calendar">
                        <h2>Calendar</h2>
                    </li>
                    <a class="btn bnt-flat btn-success" href="{{ url('offers/create') }}">Add new offer</a>
                    @role('manager')
                    <a class="btn bnt-flat btn-primary" href="{{ url('offers') }}">Offers List</a>
                    @endrole
